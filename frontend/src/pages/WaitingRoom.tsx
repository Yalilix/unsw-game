...
export function WaitingRoom() {
	...
	return (
		<div
			className="min-h-screen bg-gradient-space flex items-center justify-center p-4"
			...
			<div className="max-w-md w-full space-y-6">
				...
				<div className="bg-card p-6 rounded-lg shadow-lg">
					...
					<ul className="text-muted-foreground text-sm space-y-1 pl-4 list-disc">
						...
						<li>
							<strong>Students:</strong> Answer questions
							correctly to complete tasks and save the campus
						</li>
						<li>
							<strong>Imposters:</strong> Eliminate students and
							sabotage their mission
						</li>
						<li>
							Hold emergency meetings to discuss and vote out
							suspicious players
						</li>
						<li>
							Students win by completing all tasks or voting out
							all imposters
						</li>
						<li>
							Imposters win by eliminating enough students or
							sabotaging the campus
						</li>
					</ul>
				</div>
